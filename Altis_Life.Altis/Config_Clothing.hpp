...
class Clothing {
    ...
    class cop {
        ...
        headgear[] = {
            ...
            { "H_HelmetB_plain_mcamo", "", 75, { "life_coplevel", "SCALAR", 5 } },
            { "H_Booniehat_mcamo", "", 120, { "life_coplevel", "SCALAR", 5 } },
            { "H_MilCap_mcamo", "", 100, { "life_coplevel", "SCALAR", 5 } },
    ...
    class med_clothing {
        ...
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
            { "U_C_Scientist", "Rettungshelfer", 500, { "", "", -1 } },
            { "U_C_Scientist", "Notarzt", 1000, { "", "", -1 } }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_Cap_blu", "", 10, { "", "", -1 } }
